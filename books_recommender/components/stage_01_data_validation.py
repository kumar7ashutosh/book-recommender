...
class DataValidation:
    ...
    def preprocess_data(self):
        try:
            books = pd.read_csv(self.data_validation_config.books_csv_file,on_bad_lines='skip',encoding='latin-1',low_memory=False)
            ratings = pd.read_csv(self.data_validation_config.ratings_csv_file, on_bad_lines='skip', encoding='latin-1',low_memory=False)
